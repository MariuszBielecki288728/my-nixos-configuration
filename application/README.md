...
`compose.yaml`. Persistent application data belongs under `/var/lib/mini-pc`; back up
that directory before upgrades. Do not put secrets in this directory through Nix,
because values referenced by Nix expressions can be copied to the world-readable Nix
store.
